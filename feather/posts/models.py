...
class Post(models.Model):
    headliner = models.TextField(verbose_name="заголовок",
                            help_text='заголовок поста', null=True)
...
class Comment(models.Model):
    ...
    answer_to = models.ForeignKey('self', on_delete=models.CASCADE,
        verbose_name="Предыдущий комментарий", null=True
    )
...
#     answered = models.ForeignKey(Comment, on_delete=models.CASCADE, null=True,
#                                  verbose_name="отвеченный комментарий",
#                                  help_text='Комментарий, на который дан этот ответ',
#                                  related_name='answers')
#     answer = models.ForeignKey(Comment, on_delete=models.CASCADE, null=True,
#                                  verbose_name="ответный комментарий",
#                                  help_text='Комментарий с ответом',
#                                  related_name='answered_comms')
